...
export default function Spirituality() {
    ...
    useEffect(() => {
        const fetchBlogs = async () => {
            try {
                const res = await axios.get('http://localhost:4000/api/blogs?tag=spirituality');
                setBlogs(res.data);
            } catch (err) {
    ...
    useEffect(() => {
        const fetchExploreBlogs = async () => {
            try {
                const res = await axios.get('http://localhost:4000/api/blogs?tag=explorespirituality');
        ...
        <>
            <div className="flex flex-col h-[50vh] md:h-[680px]">
                <div
                    ...
                    style={{ backgroundImage: `url(${spirituality_hero})` }}
                >
                    ...
                    <p
                        className="nature-text absolute bottom-[10%] md:bottom-[3%] left-1/2 -translate-x-1/2 text-white font-bold text-3xl md:text-[6rem]"
                    >
                        SPIRITUALITY
                    </p>
