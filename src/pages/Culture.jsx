...
import culture_hero from '../assets/images/culture_hero.png';
...
export default function Culture() {
    ...
    useEffect(() => {
        const fetchBlogs = async () => {
            try {
                const res = await axios.get('http://localhost:4000/api/blogs?tag=culture');
                setBlogs(res.data);
            } catch (err) {
    ...
    useEffect(() => {
        const fetchExploreBlogs = async () => {
            try {
                const res = await axios.get('http://localhost:4000/api/blogs?tag=exploreculture');
        ...
        <>
            <div className="flex flex-col h-[50vh] md:h-[680px]">
                <div
                    ...
                    style={{ backgroundImage: `url(${culture_hero})` }}
                >
