...
import heritage_hero from '../assets/images/heritage_hero.png';
...
export default function Heritage() {
    ...
    useEffect(() => {
        const fetchBlogs = async () => {
            try {
                const res = await axios.get('http://localhost:4000/api/blogs?tag=heritage');
                setBlogs(res.data);
            } catch (err) {
    ...
    useEffect(() => {
        const fetchExploreBlogs = async () => {
            try {
                const res = await axios.get('http://localhost:4000/api/blogs?tag=exploreheritage');
        ...
        <>
            <div className="flex flex-col h-[50vh] md:h-[680px]">
                <div
                    ...
                    style={{ backgroundImage: `url(${heritage_hero})` }}
                >
