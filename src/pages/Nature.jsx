...
import nature_hero from '../assets/images/nature_hero.png';
        ...
        <>
            <div className="flex flex-col h-[50vh] md:h-[680px]">
                <div
                    ...
                    style={{ backgroundImage: `url(${nature_hero})` }}
                >
                    ...
                    <p
                        className="nature-text absolute bottom-[10%] md:bottom-[3%] left-1/2 -translate-x-1/2 text-white font-bold text-2xl lg:text-[6rem]"
                    >
                        NATURE
                    </p>
                        ...
                        blogs.map((blog) => (
                            <div key={blog._id} className="text-white">
                                ...
                                <div className="flex flex-col flex-grow">
                                    <h3 className="text-xl md:text-2xl font-bold mb-2 leading-tight h-[60px] line-clamp-2">
                                        {blog.heading}
                                    </h3>
                                    <p className="text-gray-400 text-xs md:text-sm font-bold tracking-widest uppercase mb-4">
                                        NATURE REVIEW
                                    </p>
                                    <p className="text-gray-300 text-base md:text-lg leading-relaxed mb-6 h-[100px] overflow-hidden">
                                    ...
                                    <button
                                        ...
                                        className="w-fit bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-6 rounded text-sm tracking-wider transition-colors uppercase"
                                    >
                                        Read More
                                    </button>
                                </div>
